...
describe('checkout tests', () => {
   ...
   */
  const CHECKOUT_URL = 'https://uat.checkout.pagopa.it/';
  ...
  const CREDIT_CARD_NUMBER_XPAY = '4000000000000101';
  ...
  it('[XPAY] Should complete the payment 3ds2 when valid credit card is entered', async () => {
